...
def create_app():
    ...
    try:
        ...
        print(f"[app.py] Failed to register market_bp: {e}")

    try:
        app.register_blueprint(orders_bp)
    except Exception as e:
        print(f"[app.py] Failed to register orders_bp: {e}")

    try:
        app.register_blueprint(algo_bp)
    except Exception as e:
        print(f"[app.py] Failed to register algo_bp: {e}")


    try:
        app.register_blueprint(backtest_bp)
    except Exception as e:
        print(f"[app.py] Failed to register backtest_bp: {e}")
    
    try:
        app.register_blueprint(recommend_bp)
    except Exception as e:
        print(f"[app.py] Failed to register recommend_bp: {e}")
